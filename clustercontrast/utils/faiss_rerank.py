...
def compute_jaccard_distance(target_features, k1=20, k2=6, print_flag=True, search_option=0, use_float16=False):
    ...
    if (search_option==0):
        ...
        # print('Using GPU and CUDA Tensors 1')
        ...
        # print('Using GPU and CUDA Tensors 2')
        res = faiss.StandardGpuResources()
    ...
    print('Completed Faiss Operations') 
    nn_k1 = []
    nn_k1_half = []
    for i in range(N):
        nn_k1.append(k_reciprocal_neigh(initial_rank, i, k1))
        nn_k1_half.append(k_reciprocal_neigh(initial_rank, i, int(np.around(k1/2))))
    print('k matricies created') 
    ...
    print('Jaccard distance matrix created') 
    del invIndex, V
