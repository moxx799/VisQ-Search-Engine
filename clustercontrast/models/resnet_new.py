...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        # weight = resnet.conv1.weight.clone() #copy over weight to clone RWM
        # resnet.conv1 = nn.Conv2d(7, 64, kernel_size=7, stride=2, padding=3, bias=False) #here 4 indicates 4-channel input
        # print(resnet)
        # new_in_channels = 7
        layer = resnet.conv1
        ...
        resnet.layer4[0].SeparableConv2d.stride = (1, 1)
