...
dn= 'connectivity0_noRECA_NeuN'
dn2='connectivity0_S10N_X' #  '
...
dst_path= '/project/roysam/rwmills/repos/cluster-contrast-reid/results/Mylo_NGroupsX'
...
try:
    dataset, test_loader = get_data(data_type,dn  , '/project/roysam/rwmills/repos/cluster-contrast-reid/examples/data', data_size,data_size,
                                mean_array, std_array, 1, 1)
except:
    dataset, test_loader = get_data(data_type,dn2  , '/project/roysam/rwmills/repos/cluster-contrast-reid/examples/data', data_size,data_size,
                                mean_array, std_array, 1, 1)
...
print('size of Q: ', len(centroid_Q))
...
print('size of G: ', len(centroid_G))


#-------------------functions:

def plot7ch_single(data, frames, minn, maxx, fname):
...
def plot7ch(data, frames, class_ids, fname):
    # print(data.shape)
    mins=[]
    maxes=[]
    for i in range(frames):
    ...
    maxx= np.amax(np.array(maxes)) + 200
...
def plot_4_brain_overlay_multiclick(cent, cl1, cl2, cl3, cl4, cutoff1, cutoff2, cutoff3, cutoff4,bigimg, fname):
    fig, axs = plt.subplots(nrows=2, ncols=2, figsize=(30, 20))
    plt.setp(axs[0,0].get_xticklabels(), visible=False)
    plt.setp(axs[0,0].get_yticklabels(), visible=False)
    plt.setp(axs[0,1].get_xticklabels(), visible=False)
    ...
    #green dots
    for i in cl1:
        axs[0,0].plot(i[1] , i[0], marker='.', color='green', markersize=15)
    for i in cl2:
        axs[1,0].plot(i[1] , i[0], marker='.', color='green', markersize=15)
    for i in cl3:
        axs[0,1].plot(i[1] , i[0], marker='.', color='green', markersize=15)
    for i in cl4:
        axs[1,1].plot(i[1] , i[0], marker='.', color='green', markersize=15)
    #multiple red dots
    for i in cent:
        axs[0,0].plot(i[1] , i[0], marker='.', color='red', markersize=15)
        axs[1,0].plot(i[1] , i[0], marker='.', color='red', markersize=15)
        axs[0,1].plot(i[1] , i[0], marker='.', color='red', markersize=15)
        axs[1,1].plot(i[1] , i[0], marker='.', color='red', markersize=15)
    ...
    axs[0,0].title.set_text('Distance Cutoff ' + str(cutoff1) + ' count: ' +  str(len(cl1)) )
    axs[0,1].title.set_text('Distance Cutoff ' + str(cutoff2) + ' count: ' +  str(len(cl2)) )
    axs[1,0].title.set_text('Distance Cutoff ' + str(cutoff3)+ ' count: '  +  str(len(cl3)) )
    axs[1,1].title.set_text('Distance Cutoff ' + str(cutoff4) + ' count: ' +  str(len(cl4)) )
    plt.subplots_adjust(wspace=.2, hspace=.2)
    # plt.show()
    print('...saving')
    fig.savefig(fname)
...
def plot_4_brain_overlay_multiclickGenInside(cent, centroid_G, centroid_Q, dist, cutoff1, cutoff2, cutoff3, cutoff4,bigimg, fname):
    fig, axs = plt.subplots(nrows=2, ncols=2, figsize=(30, 20))
    plt.setp(axs[0,0].get_xticklabels(), visible=False)
    plt.setp(axs[0,0].get_yticklabels(), visible=False)
    plt.setp(axs[0,1].get_xticklabels(), visible=False)
    ...
    #green dots
    print('getting 1... ')
    cl=generate_union_multiQuery(cent, centroid_Q, centroid_G, dist, cutoff1)
    cl1 = len(cl)
    for i in cl:
        axs[0,0].plot(i[1] , i[0], marker='.', color='green', markersize=7)
    cl=generate_union_multiQuery(cent, centroid_Q, centroid_G, dist, cutoff2)
    print('getting 2... ')
    cl2 = len(cl)
    for i in cl:
        axs[0,1].plot(i[1] , i[0], marker='.', color='green', markersize=7)
    cl=generate_union_multiQuery(cent, centroid_Q, centroid_G, dist, cutoff3)
    print('getting 3... ')
    cl3 = len(cl)
    for i in cl:
        axs[1,0].plot(i[1] , i[0], marker='.', color='green', markersize=7)
    cl=generate_union_multiQuery(cent, centroid_Q, centroid_G, dist, cutoff4)
    print('getting 4... ')
    cl4 = len(cl)
    for i in cl:
        axs[1,1].plot(i[1] , i[0], marker='.', color='green', markersize=7)
    #multiple red dots
    for i in cent:
        axs[0,0].plot(i[1] , i[0], marker='.', color='red', markersize=7)
        axs[1,0].plot(i[1] , i[0], marker='.', color='red', markersize=7)
        axs[0,1].plot(i[1] , i[0], marker='.', color='red', markersize=7)
        axs[1,1].plot(i[1] , i[0], marker='.', color='red', markersize=7)
    ...
    axs[0,0].title.set_text('Distance Cutoff ' + str(cutoff1) + ' count: ' +  str(cl1 ) )
    axs[0,1].title.set_text('Distance Cutoff ' + str(cutoff2) + ' count: ' +  str(cl2 ))
    axs[1,0].title.set_text('Distance Cutoff ' + str(cutoff3)+ ' count: '  +  str(cl3 ))
    axs[1,1].title.set_text('Distance Cutoff ' + str(cutoff4) + ' count: ' +  str(cl4 ))
    plt.subplots_adjust(wspace=.2, hspace=.2)
    # plt.show()
    print('...saving')
    fig.savefig(fname)
...
clicks = np.load('/project/roysam/rwmills/repos/cluster-contrast-reid/examples/data/clicks/clicks2.npy')
clicks = clicks[28::]
step_size = 8

all_samples = int(len(clicks)/step_size)
segs = range(0, len(clicks), step_size)
t=0

for t in range( all_samples):
    query_list = clicks[segs[t] : segs[t+1]]
    # cmap_list = ['YlOrBr_r', 'Oranges_r','BuGn_r', 'Blues_r', 'Reds_r','PuBuGn_r', 'Purples_r', 'RdPu_r', 'Greens_r', 'Greens_r']
    # pic_array = []
    # for int_cent1 in query_list:
    #     sD1a, sI1a = find_several_cents_to_pt((int_cent1 ), centroid_Q)
    #     indx =sI1a[0]
    ...
    # save_name  = os.path.join(dst_path, str(indx) + '_' + str(t) + '_targetCloseUps.png')
    # plot7ch(pic, pic.shape[2], [], save_name)
    #calculating similar ones
    # a, b, c, d =  1.1, 1.2, 1.3, 1.4 # 0.7, 0.8, 0.9, 1
    a,b,c,d = 0.7, 0.8, 0.9, 1
    # print('Generating similar centroid lists')
    # c1 = generate_union_multiQuery(query_list, centroid_Q, centroid_G, dist, a)
    # c2 = generate_union_multiQuery(query_list, centroid_Q, centroid_G, dist, b)
    # c3 = generate_union_multiQuery(query_list, centroid_Q, centroid_G, dist, c)
    # c4 = generate_union_multiQuery(query_list, centroid_Q, centroid_G, dist, d)
    ...
    #         maxes.append(np.amax(data[:,:,i]))
    # minn = np.amin(np.array(mins))
    # maxx= np.amax(np.array(maxes))
    fname  = os.path.join(dst_path,  str(t) + '_AtlasOverlaysCor.png')
    # plot_4_brain_overlay_multiclick(query_list, c1, c2, c3, c4, a, b, c, d, brain_img_orig, fname)
    plot_4_brain_overlay_multiclickGenInside(query_list, centroid_G, centroid_Q, dist, a, b, c, d ,brain_img_orig, fname)
    ...
    #     pic = imread(dataset.gallery[indx][0])
    #     pic_array.append(pic)
    # save_name  = os.path.join(dst_path, str(indx) + '_' + str(t) + '_12similarCloseUps.png')
    # plot7ch(pic, pic.shape[2], [], save_name)
